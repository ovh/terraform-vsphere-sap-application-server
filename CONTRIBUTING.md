# Contributing to terraform-vsphere-sap-application-server
...
terraform-vsphere-sap-application-server is licensed under a Apache License 2 license. Anything
contributed to terraform-vsphere-sap-application-server must be released under this license.
